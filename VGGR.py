...
if __name__ == '__main__':
    ...
    # Train mode
        ...
        if args.model == 'cnn_v1':
            train_model(model=cnn_v1, epochs=20, batch_size=400, learn_rate=0.001, device=args.device)
        elif args.model == 'cnn_v2':
            train_model(model=cnn_v2, epochs=20, batch_size=160, learn_rate=0.01, device=args.device)
        elif args.model == 'cnn_v3':
            train_model(model=cnn_v3, epochs=20, batch_size=400, learn_rate=0.001, device=args.device)
        else:
