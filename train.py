...
cnn_v1 = CNNv1(input_shape=3, hidden_units=4, output_shape=train_data.genre_count)
cnn_v2 = CNNv2(input_shape=3, hidden_units=8, output_shape=train_data.genre_count)
cnn_v3 = CNNv3(input_shape=3, hidden_units=4, output_shape=train_data.genre_count)
...
def train_model(model, epochs: int, batch_size: int, learn_rate: float, device=device_options):
    # Dataloader
